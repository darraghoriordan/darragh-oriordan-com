...
class TinyLetterSignup extends React.Component<any, any> {
  public tinyLetterFormOnClick = () => {
    window.open(
      "https://tinyletter.com/darraghor",
      "popupwindow",
  ...
  public render() {
    return (
      <div>
        ...
        <p>
          Get monthly updates and interesting tech news that I come across. I
          read heaps and pop the best stuff in a monthly email.
        </p>
        <TinyLetterForm
        ...
        >
          ...
          <p>
            <TinyLetterInput type="text" name="email" id="tlemail" />
          </p>
